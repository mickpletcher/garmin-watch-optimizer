...
| --- | --- | --- | --- | --- | --- |
| Python 3.12 | Supported | PR #2 passed | PR #2 passed | GitHub Actions CI | Automated validated 2026-08-30 |
| Python 3.13 | Supported | PR #2 passed | PR #2 passed | GitHub Actions CI | Automated validated 2026-08-30 |
